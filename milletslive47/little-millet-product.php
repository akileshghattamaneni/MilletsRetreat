            ...
            <div class="container">
                <div class="archive-header">
                    <div class="row align-items-center">
                        <div class="col-xl-8">
                            <h1 class="mb-15">Little Millets (Samalu)</h1>
                            <div class="breadcrumb">
                                <a href='index.php' rel='nofollow'><i class="fi-rs-home mr-5"></i>Home</a>
                                <span></span> Little Millets (Samalu)
                            </div>
                        </div>
            ...
            <div class="row">
                <div class="col-xl-10 col-lg-12 m-auto">
                    <div class="product-detail accordion-detail">
                        ...
                        $imagePaths = array(
                            "assets/imgs/millets/millet/little-millets/1.png",
                            "assets/imgs/millets/millet/little-millets/2.png",
                            "assets/imgs/millets/millet/little-millets/3.png",
                            "assets/imgs/millets/millet/little-millets/4.png",
                            "assets/imgs/millets/millet/little-millets/5.png",
                            "assets/imgs/millets/millet/little-millets/6.png",
                            "assets/imgs/millets/millet/little-millets/7.png",
                            "assets/imgs/millets/millet/little-millets/8.png",
                            "assets/imgs/millets/millet/little-millets/9.png"
                        );
                        ...
                        ?>
                            ...
                            <div class="col-md-6 col-sm-12 col-xs-12">
                                <div class="detail-info pr-30 pl-30">
                                    ...
                                    <h2 class="title-detail">Little Millets (Samalu)</h2>
                                    ...
                                    <div class="short-desc mb-30">
                                        <p class="font-lg">Little millet, also known as kutki, is a
                                            nutritious and gluten-free grain
                                            that offers a variety of culinary possibilities. From
                                            traditional dishes to
                                            modern creations, little millet products cater to diverse
                                            tastes and dietary
                                            needs.</p>
                                    </div>
