                ...
                <div class="col-12">
                    <div class="shop-product-fillter">
                        <div class="totall-product">
                            <p>We found <strong class="text-brand">17</strong> items for you!</p>
                        </div>
                ...
                <div class="row product-grid-4">
                    ...
                    <?php
                         foreach ($products as $id => $product) {
                            ...
                            echo "</a>";
                            echo "</div>";
                            // echo "<div class='product-action-1'>";
                            // echo "<a aria-label='Add To Wishlist' class='action-btn' href='#'><i class='fi-rs-heart'></i></a>";
                            // echo "<a aria-label='Quick view' class='action-btn' data-bs-toggle='modal' data-bs-target='#quickViewModal{$id}'><i class='fi-rs-eye'></i></a>";
                            // echo "</div>";
                            ...
                            echo "<a class='add' href='millets.php?product_id={$id}'><i class='fi-rs-shopping-cart mr-5'></i>Add </a>";
                            echo "</div>";
                            echo "</div>";
                            echo "</div>";
                            echo "</div>";
                        ...
                        <div class="product-cart-wrap mb-30">
                            <div class="product-img-action-wrap">
                                ...
                                <div class="product-action-1">
                                    ...
                                    <a aria-label="Quick view" class="action-btn" data-bs-toggle="modal"
                                        data-bs-target="#quickViewModal10"><i class="fi-rs-eye"></i></a>
                                </div>
                                <div class="product-badges product-badges-position product-badges-mrg">
                                    <span class="hot">Hot</span>
                                </div>
                            ...
                            <div class="product-content-wrap">
                                ...
                                <h2><a href='shop-product-full.php'>Emmer Wheat Flour</h2>

                                <div>
                                    <span class="font-small text-muted">250gm</span>
                                </div>
                                <div class="product-card-bottom">
                                    <div class="product-price">
                                        <span>₹180.8</span>
                    ...
                    <div class="col-lg-1-5 col-md-4 col-12 col-sm-6">
                        <div class="product-cart-wrap mb-30">
                            ...
                            <div class="product-content-wrap">
                                ...
                                <h2><a href='shop-product-full.php'>Atta Wheat Flour</a></h2>
                    ...
                    <div class="col-lg-1-5 col-md-4 col-12 col-sm-6">
                        <div class="product-cart-wrap mb-30">
                            ...
                            <div class="product-content-wrap">
                                ...
                                <h2><a href='shop-product-full.php'>Siri Dhanya Atta</a></h2>
                    ...
                    <div class="col-lg-1-5 col-md-4 col-12 col-sm-6">
                        <div class="product-cart-wrap mb-30">
                            ...
                            <div class="product-content-wrap">
                                ...
                                <h2><a href='shop-product-full.php'>White Wheat Flour</a></h2>
                    ...
                    <div class="col-lg-1-5 col-md-4 col-12 col-sm-6">
                        <div class="product-cart-wrap mb-30">
                            ...
                            <div class="product-content-wrap">
                                ...
                                <h2><a href='shop-product-full.php'>Organic Ragi Flour</a></h2>
