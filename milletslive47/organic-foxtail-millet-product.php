            ...
            <div class="container">
                <div class="archive-header">
                    <div class="row align-items-center">
                        <div class="col-xl-8">
                            <h1 class="mb-15">Organic Foxtail Millet (Korralu)</h1>
                            <div class="breadcrumb">
                                <a href='index.php' rel='nofollow'><i class="fi-rs-home mr-5"></i>Home</a>
                                <span></span> Organic Foxtail Millet (Korralu)
                            </div>
                        </div>
            ...
            <div class="row">
                <div class="col-xl-10 col-lg-12 m-auto">
                    <div class="product-detail accordion-detail">
                        ...
                        $imagePaths = array(
                            "assets/imgs/millets/millet/11.png",
                            "assets/imgs/millets/millet/12.png",
                            "assets/imgs/millets/millet/13.png",
                            "assets/imgs/millets/millet/14.png",
                            "assets/imgs/millets/millet/15.png",
                            "assets/imgs/millets/millet/16.png",
                            "assets/imgs/millets/millet/17.png",
                            "assets/imgs/millets/millet/18.png",
                            "assets/imgs/millets/millet/19.png"
                        );
                        ...
                        ?>
                            ...
                            <div class="col-md-6 col-sm-12 col-xs-12">
                                <div class="detail-info pr-30 pl-30">
                                    ...
                                    <h2 class="title-detail">Organic Foxtail Millet (Korralu)</h2>

                                    <div class="clearfix product-price-cover">
                                        <div class="product-price primary-color float-left">
                                            <span class="current-price text-brand">&#8377;220</span>

                                        </div>
                                    </div>
                                    <div class="short-desc mb-30">
                                        <p class="font-lg">Foxtail millet products encompass flour for baking, whole
                                            grains as rice substitutes, breakfast cereals, snack foods like chips,
                                            beverages including milk substitutes, and ready-to-eat meals, offering
                                            diverse culinary options.</p>
                                    </div>
                            ...
                            <div class="row related-products">
                                ...
                                <div class="col-lg-3 col-md-4 col-12 col-sm-6">
                                    <div class="product-cart-wrap hover-up">
                                        ...
                                        <div class="product-content-wrap">
                                            <h2><a href='pearl-millets-product.php' tabindex='0'>Pearl Millets</a>
                                            </h2>
                                            <div class="rating-result" title="90%">
                                                <span>1kg </span>
                                            </div>
