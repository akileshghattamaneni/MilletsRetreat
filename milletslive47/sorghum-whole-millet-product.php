            ...
            <div class="container">
                <div class="archive-header">
                    <div class="row align-items-center">
                        <div class="col-xl-8">
                            <h1 class="mb-15">Sorghum Whole Millet (Jonnalu)</h1>
                            <div class="breadcrumb">
                                <a href='index.php' rel='nofollow'><i class="fi-rs-home mr-5"></i>Home</a>
                                <span></span> Sorghum Whole Millet (Jonnalu)
                            </div>
                        </div>
            ...
            <div class="row">
                <div class="col-xl-10 col-lg-12 m-auto">
                    <div class="product-detail accordion-detail">
                        ...
                        $imagePaths = array(
                            "assets/imgs/millets/millet/sorghum-millets/1.png",
                            "assets/imgs/millets/millet/sorghum-millets/2.png",
                            "assets/imgs/millets/millet/sorghum-millets/3.png",
                            "assets/imgs/millets/millet/sorghum-millets/4.png",
                            "assets/imgs/millets/millet/sorghum-millets/5.png",
                            "assets/imgs/millets/millet/sorghum-millets/6.png",
                            "assets/imgs/millets/millet/sorghum-millets/7.png",
                            "assets/imgs/millets/millet/sorghum-millets/8.png",
                            "assets/imgs/millets/millet/sorghum-millets/9.png"
                        );
                        ...
                        ?>
                            ...
                            <div class="col-md-6 col-sm-12 col-xs-12">
                                <div class="detail-info pr-30 pl-30">
                                    ...
                                    <h2 class="title-detail">Sorghum Whole Millet (Jonnalu)</h2>

                                    <div class="clearfix product-price-cover">
                                        <div class="product-price primary-color float-left">
                                            <span class="current-price text-brand">&#8377;90</span>

                                        </div>
                                    </div>
                                    <div class="short-desc mb-30">
                                        <p class="font-lg">Sorghum millet, a nutritious and gluten-free
                                            grain, offers a
                                            diverse range of products that cater to various dietary
                                            needs and culinary
                                            preferences. Common sorghum millet products include whole
                                            grains, flour,
                            ...
                            <div class="row related-products">
                                ...
                                <div class="col-lg-3 col-md-4 col-12 col-sm-6">
                                    <div class="product-cart-wrap hover-up">
                                        ...
                                        <div class="product-content-wrap">
                                            <h2><a href='ragi-finger-millet-product.php' tabindex='0'>Ragi
                                                    Finger
                                                    Millet</a></h2>
                                            <div class="rating-result" title="90%">
                                                <span>1kg </span>
                                ...
                                <div class="col-lg-3 col-md-4 col-12 col-sm-6 d-lg-block d-none">
                                    <div class="product-cart-wrap hover-up mb-0">
                                        <div class="product-img-action-wrap">
                                            <div class="product-img product-img-zoom">
                                                <a href='barnyard-millet-product.php' tabindex='0'>
                                                    <img class="default-img"
                                                        src="assets/imgs/millets/millet/barnyard-millets/1.png"
                                                        alt="" />
                                                    <img class="hover-img"
                                                        src="assets/imgs/millets/millet/barnyard-millets/1.png"
                                                        alt="" />
                                        ...
                                        <div class="product-content-wrap">
                                            <h2><a href='barnyard-millet-product.php' tabindex='0'>Barnyard
                                                    Millet</a></h2>
                                            <div class="rating-result" title="90%">
                                                <span>1kg </span>
                                            </div>
