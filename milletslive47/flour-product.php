                        ...
                        <div class="row mb-50 mt-30">
                                ...
                                <div class="detail-gallery">
                                    ...
                                    <div class="product-image-slider">
                                        <figure class="border-radius-10">
                                            <img src="assets/imgs/millets/11.png" alt="product image" />
                                        </figure>
                                        <figure class="border-radius-10">
                                            <img src="assets/imgs/millets/11.png" alt="product image" />
                                        </figure>
                                    ...
                                    <div class="slider-nav-thumbnails">
                                        <div><img src="assets/imgs/millets/11.png" alt="product image" /></div>
                                        <div><img src="assets/imgs/millets/11.png" alt="product image" /></div>
                                        <div><img src="assets/imgs/millets/11.png" alt="product image" /></div>
                                        <div><img src="assets/imgs/millets/11.png" alt="product image" /></div>
                                        <div><img src="assets/imgs/millets/11.png" alt="product image" /></div>
                            ...
                            <div class="col-md-6 col-sm-12 col-xs-12">
                                <div class="detail-info pr-30 pl-30">
                                    ...
                                    <h2 class="title-detail">Flour (Comming Soon)</h2>
                                    ...
                                    <div class="clearfix product-price-cover">
                                        <div class="product-price primary-color float-left">
                                            <span class="current-price text-brand">₹299</span>
                                            <span>
                                                <span class="save-price font-md color3 ml-15">26% Off</span>
                                                <span class="old-price font-md ml-15">₹352</span>
                                            </span>
                                        </div>
                                    </div>
                                    <div class="short-desc mb-30">
                                        <p class="font-lg">Flour, the versatile powder ground from grains like wheat,
                                            corn, or rice, is a cornerstone of culinary endeavors worldwide. It serves
                                            as the backbone of baking, thickening sauces, and coating proteins for
                                            frying. With various types available, from all-purpose to specialty blends,
                                            flour is an essential pantry staple for cooks everywhere.
                                        </p>
                                    </div>
