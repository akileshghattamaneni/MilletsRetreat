            ...
            <div class="container">
                <div class="archive-header">
                    <div class="row align-items-center">
                        <div class="col-xl-8">
                            <h1 class="mb-15">Barnyard Millet (Oodalu)</h1>
                            <div class="breadcrumb">
                                <a href='index.php' rel='nofollow'><i class="fi-rs-home mr-5"></i>Home</a>
                                <span></span> Barnyard Millet (Oodalu)
                            </div>
                        </div>
            ...
            <div class="row">
                <div class="col-xl-10 col-lg-12 m-auto">
                    <div class="product-detail accordion-detail">
                        ...
                        $imagePaths = array(
                            "assets/imgs/millets/millet/barnyard-millets/1.png",
                            "assets/imgs/millets/millet/barnyard-millets/2.png",
                            "assets/imgs/millets/millet/barnyard-millets/3.png",
                            "assets/imgs/millets/millet/barnyard-millets/4.png",
                            "assets/imgs/millets/millet/barnyard-millets/5.png",
                            "assets/imgs/millets/millet/barnyard-millets/6.png",
                            "assets/imgs/millets/millet/barnyard-millets/7.png",
                            "assets/imgs/millets/millet/barnyard-millets/8.png",
                            "assets/imgs/millets/millet/barnyard-millets/9.png"
                        );
                        ...
                        ?>
                            ...
                            <div class="col-md-6 col-sm-12 col-xs-12">
                                <div class="detail-info pr-30 pl-30">
                                    ...
                                    <h2 class="title-detail">Barnyard Millet (Oodalu)</h2>
                                    ...
                                    <div class="short-desc mb-30">
                                        <p class="font-lg">Barnyard millet, often referred to as "sanwa"
                                            or "samvat," is a gluten-free
                                            grain that is gaining popularity for its nutritional
                                            benefits and
                                            versatility in culinary applications. From traditional
                                            dishes to modern
                                            innovations, barnyard millet offers a range of products that
                                            cater to
                                            various dietary preferences and culinary tastes.</p>
                                    </div>
