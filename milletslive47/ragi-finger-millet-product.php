            ...
            <div class="container">
                <div class="archive-header">
                    <div class="row align-items-center">
                        <div class="col-xl-8">
                            <h1 class="mb-15">Finger Millet (Ragi)</h1>
                            <div class="breadcrumb">
                                <a href='index.php' rel='nofollow'><i class="fi-rs-home mr-5"></i>Home</a>
                                <span></span> Finger Millet (Ragi)
                            </div>
                        </div>
            ...
            <div class="row">
                <div class="col-xl-10 col-lg-12 m-auto">
                    <div class="product-detail accordion-detail">
                        ...
                        $imagePaths = array(
                            "assets/imgs/millets/millet/finger-millets/1.png",
                            "assets/imgs/millets/millet/finger-millets/2.png",
                            "assets/imgs/millets/millet/finger-millets/3.png",
                            "assets/imgs/millets/millet/finger-millets/4.png",
                            "assets/imgs/millets/millet/finger-millets/5.png",
                            "assets/imgs/millets/millet/finger-millets/6.png",
                            "assets/imgs/millets/millet/finger-millets/7.png",
                            "assets/imgs/millets/millet/finger-millets/8.png",
                            "assets/imgs/millets/millet/finger-millets/9.png"
                        );
                        ...
                        ?>
                            ...
                            <div class="col-md-6 col-sm-12 col-xs-12">
                                <div class="detail-info pr-30 pl-30">
                                    ...
                                    <h2 class="title-detail">Finger Millet (Ragi)</h2>
                                    ...
                                    <div class="short-desc mb-30">
                                        <p class="font-lg">Ragi, also known as finger millet, is a
                                            highly nutritious
                                            grain with a plethora of culinary applications. From staple
                                            foods to snacks
                                            and beverages, ragi offers a wide variety of products that
                                            cater to diverse
                                            tastes and dietary preferences.</p>
                                    </div>
                                    ...
                                    <div class="product-cart-wrap hover-up mb-0">
                                        <div class="product-img-action-wrap">
                                            ...
                                            <!-- <div class="product-action-1">
                                                ...
                                                <a aria-label="Quick view" class="action-btn" data-bs-toggle="modal"
                                                    data-bs-target="#quickViewModal9"><i class="fi-rs-eye"></i></a>
                                            </div> -->
                                            <div class="product-badges product-badges-position product-badges-mrg">
