            ...
            <div class="container">
                <div class="archive-header">
                    <div class="row align-items-center">
                        <div class="col-xl-8">
                            <h1 class="mb-15">Pearl Millets (Sajjalu)</h1>
                            <div class="breadcrumb">
                                <a href='index.php' rel='nofollow'><i class="fi-rs-home mr-5"></i>Home</a>
                                <span></span> Pearl Millets (Sajjalu)
                            </div>
                        </div>
            ...
            <div class="row">
                <div class="col-xl-10 col-lg-12 m-auto">
                    <div class="product-detail accordion-detail">
                        ...
                        $imagePaths = array(
                            "assets/imgs/millets/millet/pearl-millets/1.png",
                            "assets/imgs/millets/millet/pearl-millets/2.png",
                            "assets/imgs/millets/millet/pearl-millets/3.png",
                            "assets/imgs/millets/millet/pearl-millets/4.png",
                            "assets/imgs/millets/millet/pearl-millets/5.png",
                            "assets/imgs/millets/millet/pearl-millets/6.png",
                            "assets/imgs/millets/millet/pearl-millets/7.png",
                            "assets/imgs/millets/millet/pearl-millets/8.png",
                            "assets/imgs/millets/millet/pearl-millets/9.png"
                        );
                        ...
                        ?>
                            ...
                            <div class="col-md-6 col-sm-12 col-xs-12">
                                <div class="detail-info pr-30 pl-30">
                                    ...
                                    <h2 class="title-detail">Pearl Millets (Sajjalu)</h2>
                                    ...
                                    <div class="short-desc mb-30">
                                        <p class="font-lg">Pearl millet, also known as bajra, is a versatile grain that
                                            serves as a
                                            staple food for millions of people around the world. From
                                            traditional dishes
                                            to modern innovations, pearl millet offers a variety of products
                                            that are
                                            both nutritious and delicious.</p>
                                    </div>
