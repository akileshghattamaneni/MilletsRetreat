...
<head>
    <meta charset="utf-8" />
    <title>Millets Retreat | Profile</title>
    ...
    <script type="module" src="assets/js/header-icon.js" defer></script>
</head>
                                ...
                                <div class="tab-content account dashboard-content pl-50">
                                    <div class="tab-pane fade active show" id="dashboard" role="tabpanel"
                                        ...
                                        <div class="card">
                                            ...
                                            <div class="">
                                                <p>
                                                    Welcome to Millets Retreat, From your account dashboard. you can
                                                    easily check &amp; view your <a href="#">recent orders</a>,
                                    ...
                                    <div class="tab-pane fade" id="account-detail" role="tabpanel"
                                        ...
                                        <div class="card">
                                            ...
                                            <div class="card-body">
                                                <p>Already have an account? <a href='login.php'>Log in
                                                        instead!</a></p>
