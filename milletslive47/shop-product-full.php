                        ...
                        <div class="row mb-50 mt-30">
                            ...
                            <div class="col-md-6 col-sm-12 col-xs-12">
                                <div class="detail-info pr-30 pl-30">
                                    ...
                                    <h2 class="title-detail">Batters (Comming Soon)</h2>
                                    ...
                                    <div class="clearfix product-price-cover">
                                        <div class="product-price primary-color float-left">
                                            <span class="current-price text-brand">₹199</span>
                                            <span>
                                                <span class="save-price font-md color3 ml-15">26% Off</span>
                                                <span class="old-price font-md ml-15">₹250</span>
                                            </span>
                                        </div>
                                    </div>
                                    <div class="short-desc mb-30">ss
                                        <p class="font-lg">Batter is a liquid mixture of flour, eggs, milk, and other
                                            ingredients, used in cooking to coat foods before frying or baking. It's a
                                            key component in making pancakes, waffles, and various baked goods,
                                            providing a base that transforms into a light, fluffy texture when cooked.
                                        </p>
                                    </div>
